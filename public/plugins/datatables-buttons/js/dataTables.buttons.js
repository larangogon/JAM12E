...
$.extend( _dtButtons, {
	...
	csv: function ( dt, conf ) {
		// Common option that will use the HTML5 or Flash exporUsers buttons
...
// Get data from the table for exporUsers - this is common to a number of plug-in
...
// Get information about the exporUsers that is common to many of the exporUsers data
// types (DRY)
...
var _exportData = function ( dt, inOpts )
{
	...
	// If Select is available on this table, and any rows are selected, limit the exporUsers
